...
`CanadaâNova Scotia Offshore Petroleum Resources Accord Implementation and Offshore Renewable Energy Management Act` â subsection `7`(1)


## `Nuclear Safety and Control Act`

Consultation â subsection `7`(1)

Consultation â subsections `8`(1) and (2)

Limit â subsection `7`(1)

Limit â subsections `8`(1) and (2)
...
**federal regulatory body**âmeans
...
**Minister**âmeans the member of the Kingâs Privy Council for Canada designated under section `6`.â(**ministre**)

**provincial or territorial regulatory body**âmeans
...
### Section 11
  ...
  **(1)** The Governor in Council may, on the recommendation of the Minister, make regulations respecting federal barriers to the interprovincial movement of goods and provision of services and to the movement of labour within Canada, including regulations
    ...
    respecting, for the purposes of subsections `8`(2) and `9`(2), the meaning of the expressions âsame aspect or elementâ and âachieve a similar objectiveâ or any term used in those expressions;

    respecting the meaning of the term âauthorizationâ for the purposes of this Act;
...
Whereas Parliament recognizes that it is in the interests of Canadaâs economy, sovereignty and security, including its energy security, to urgently advance projects throughout Canada, including in the North, that are in the national interest, including projects that
...
**authorization**âmeans, in respect of a national interest project, an approval or other decision, or a permit, licence, regulation or other document or instrument, that is required, by a provision of an enactment or, if a portion of an enactment is listed in column 2 of Part 1 or Part 2 of Schedule 2, by that portion of the enactment, to permit the project to be carried out, in whole or in part.â(**autorisation**)

**enactment**âmeans an Act of Parliament listed in column 1 of Part 1 of Schedule 2 or a regulation listed in column 1 of Part 2 of that Schedule.â(**texte lÃ©gislatif**)

**Indigenous peoples**âhas the meaning assigned by the definition aboriginal peoples of Canada in subsection 35(2) of the `Constitution Act, 1982`.â(**peuples autochtones**)
...
The purpose of this Act is to enhance Canadaâs prosperity, national security, economic security, national defence and national autonomy by ensuring that projects that are in the national interest are advanced through an accelerated process that enhances regulatory certainty and investor confidence, while protecting the environment and respecting the rights of Indigenous peoples.
...
### Section 5
  ...
  **(6)** In deciding whether to make an order under subsection (1) or (4) in respect of a project, the Governor in Council may consider any factor that the Governor in Council considers relevant, including the extent to which the project can
    ...
    strengthen Canadaâs autonomy, resilience and security;
...
### Section 9
  ...
  **(1)** Before issuing a document under subsection 7(1) in respect of a project to which the `CanadaâNewfoundland and Labrador Atlantic Accord Implementation and Offshore Renewable Energy Management Act` applies, the Minister must consult with the CanadaâNewfoundland and Labrador Offshore Energy Regulator with respect to the conditions that should be set out in the document.

  **(2)** Before amending a condition or document under subsection 8(1) or (2) in respect of a project to which the `CanadaâNewfoundland and Labrador Atlantic Accord Implementation and Offshore Renewable Energy Management Act` applies, the Minister must consult with the CanadaâNewfoundland and Labrador Offshore Energy Regulator with respect to the amendment.

### Section 10

  **(1)** Before issuing a document under subsection `7`(1) in respect of a project to which the `CanadaâNova Scotia Offshore Petroleum Resources Accord Implementation and Offshore Renewable Energy Management Act` applies, the Minister must consult with the CanadaâNova Scotia Offshore Energy Regulator with respect to the conditions that should be set out in the document.

  **(2)** Before amending a condition or document under subsection `8`(1) or (2) in respect of a project to which the `CanadaâNova Scotia Offshore Petroleum Resources Accord Implementation and Offshore Renewable Energy Management Act` applies, the Minister must consult with the CanadaâNova Scotia Offshore Energy Regulator with respect to the amendment.
