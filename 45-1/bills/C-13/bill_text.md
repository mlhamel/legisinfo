...
Schedule VII to the `Financial Administration Act` is amended by replacing âComprehensive and Progressive Agreement for Trans-Pacific Partnership between Canada, Australia, Brunei, Chile, Japan, Malaysia, Mexico, New Zealand, Peru, Singapore and Vietnam, done at Santiago on March 8, 2018.â with the following:
...
Schedule 2 to the `Commercial Arbitration Act` is amended by replacing âComprehensive and Progressive Agreement for Trans-Pacific Partnership between Canada, Australia, Brunei, Chile, Japan, Malaysia, Mexico, New Zealand, Peru, Singapore and Vietnam, done at Santiago on March 8, 2018â in column 2 with the following:
...
### Section 52.82
  ...
  **(2)** If âAâ is set out in the column entitled âPreferential Tariffâ in the List of Tariff Provisions following the abbreviation âCPUKTâ in relation to goods entitled to the Comprehensive and Progressive United Kingdom Tariff, the Comprehensive and Progressive United Kingdom Tariff rate of customs duty that applies to those goods is the final rate of âFreeâ.

  **(3)** If âFâ is set out in the column entitled âPreferential Tariffâ in the List of Tariff Provisions following the abbreviation âCPUKTâ in relation to goods entitled to the Comprehensive and Progressive United Kingdom Tariff, the Comprehensive and Progressive United Kingdom Tariff rate of customs duty that applies to those goods is the initial rate, reduced as provided in the âFâ Staging List.

  **(4)** Subject to subsection (5), if âX78â, âX79â or âX80â is set out in the column entitled âPreferential Tariffâ in the List of Tariff Provisions following the abbreviation âCPUKTâ in relation to goods entitled to the Comprehensive and Progressive United Kingdom Tariff, the Comprehensive and Progressive United Kingdom Tariff rate of customs duty that applies to those goods is,

    if âX78â is set out, the initial rate, reduced,
    ...
    effective on January 1, 2028, to the final rate of âFreeâ;

    if âX79â is set out, the initial rate,
    ...
    reduced, effective on January 1, 2029, to the final rate of âFreeâ; and

    if âX80â is set out, the initial rate, reduced,
    ...
    effective on January 1, 2029, to the final rate of âFreeâ.
  ...
  **(9)** If, for any goods other than motor vehicles of heading No. 87.01, 87.02, 87.03, 87.04 or 87.05, a reduction under subsection (3) or (4) results in a rate of customs duty that is a percentage of less than two per cent, the rate shall be further reduced to âFreeâ immediately.
...
The List of Countries and Applicable Tariff Treatments set out in the schedule to the Act is amended by adding, in the column âTariff Treatment / Otherâ, a reference to âCPUKTâ opposite the references to âChannel Islandsâ, âIsle of Manâ and âUnited Kingdomâ.

### Section 18

The List of Tariff Provisions set out in the schedule to the Act is amended by

adding in the column âPreferential Tariff / Initial Rateâ, above the reference to âGPTâ, a reference to âCPUKT:â;

adding in the column âPreferential Tariff / Final Rateâ, above the reference to âGPTâ, a reference to âCPUKT:â;

adding in the column âPreferential Tariff / Initial Rateâ a reference to âFreeâ after the abbreviation âCPUKTâ, and adding in the column âPreferential Tariff / Final Rateâ a reference to âFree (A)â after the abbreviation âCPUKTâ, for all tariff items except those tariff items set out in Schedules 2 and 3 to this Act;

adding in the columns âPreferential Tariff / Initial Rateâ and âPreferential Tariff / Final Rateâ, a reference to âN/Aâ after the abbreviation âCPUKTâ for those tariff items set out in Schedule 2 to this Act; and

adding in the columns âPreferential Tariff / Initial Rateâ and âPreferential Tariff / Final Rateâ after the abbreviation âCPUKTâ, for each tariff item set out in Schedule 3 to this Act, the rates of customs duty and staging categories set out with respect to that tariff item in that Schedule.
