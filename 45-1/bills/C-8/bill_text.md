...
Critical cyber system â obligation of designated operator
...
Review of cyber security program â commencement

Notification â other changes
...
Authority to enter place â Superintendent
...
Authority to enter place â inspector
...
Authority to enter place â designated person
...
Authority to enter place â inspection officer
...
Authority to enter place â Minister of Transport
...
Notice of violation â Superintendent
...
Notice of violation â designated person
...
Notice of violation â Minister of Transport
...
Section 7 of the `Telecommunications Act` is amended by striking out âandâ at the end of paragraph (h), by adding âandâ at the end of paragraph (i) and by adding the following after paragraph (i):
...
### Section 15.2
  ...
  **(2)** If the Minister believes on reasonable grounds that it is necessary to do so to secure the Canadian telecommunications system against any threat, including that of interference, manipulation, disruption or degradation, the Minister may, by order,
    ...
    impose conditions on a telecommunications service providerâs use of any product or service, or any product or service provided by a specified person, including a telecommunications service provider;
    ...
    require that a telecommunications service providerâs telecommunications networks or telecommunications facilities, as well as its procurement plans for those networks or facilities, be subject to specified review processes;
    ...
    require that assessments be conducted to identify any vulnerability in a telecommunications service providerâs telecommunications services, telecommunications networks or telecommunications facilities or its security plan referred to in paragraph (i);
...
### Section 15.5
  ...
  **(2)** The following definitions apply in paragraph (1)(d).
    ...
    **de-identify**âmeans to modify personal information so that an individual cannot be directly identified from it, though a risk of the individual being identified remains.â(**dÃ©personnaliser**)
...
### Administrative Monetary Penalties â Security of the Canadian Telecommunications System
...
### Section 72.133
  ...
  **(1)** The amount of the administrative monetary penalty is to be determined by taking into account the following factors:
    ...
    the personâs ability to pay the penalty;
...
Whereas the Government of Canada has a fundamental responsibility to protect Canadaâs national security and the safety of Canadians;
...
**appropriate regulator**âmeans, in respect of a designated operator, the regulator set out in column 2 of Schedule 2 that corresponds to the class of operators to which the designated operator belongs.â(**organisme rÃ©glementaire compÃ©tent**)

**Bank**âmeans the Bank of Canada established by subsection 3(1) of the `Bank of Canada Act`.â(**Banque**)

**Canadian Energy Regulator**âmeans the Canadian Energy Regulator established by subsection 10(1) of the `Canadian Energy Regulator Act`.â(**RÃ©gie canadienne de lâÃ©nergie**)

**Canadian Nuclear Safety Commission**âmeans the Commission established by subsection 8(1) of the `Nuclear Safety and Control Act`.â(**Commission canadienne de sÃ»retÃ© nuclÃ©aire**).

**Chief Executive Officer**âhas the same meaning as in section 2 of the `Canadian Energy Regulator Act`.â(**prÃ©sident-directeur gÃ©nÃ©ral**)

**Commission**âmeans the Commission referred to in subsection 26(1) of the `Canadian Energy Regulator Act`.â(**Commission**)

**confidential information**âmeans any information obtained under this Act in respect of a critical cyber system that

concerns a vulnerability of any designated operatorâs critical cyber system or the methods used to protect that system and that is consistently treated as confidential by the designated operator;
...
if disclosed could reasonably be expected to interfere with contractual or other negotiations of a designated operator.â(**renseignements confidentiels**)

**critical cyber system**âmeans a cyber system that, if its confidentiality, integrity or availability were compromised, could affect the continuity or security of a vital service or vital system.â(**cybersystÃ¨me essentiel**)
...
the confidentiality, integrity or availability of the critical cyber system.â(**incident de cybersÃ©curitÃ©**)

**cyber system**âmeans a system of interdependent digital services, technologies, assets or facilities that form the infrastructure for the reception, transmission, processing or storing of information.â(**cybersystÃ¨me**)

**designated operator**âmeans a person, partnership or unincorporated organization that belongs to any class of operators referred to in Schedule 2.â(**exploitant dÃ©signÃ©**)
...
the Canadian Nuclear Safety Commission.â(**organisme rÃ©glementaire**)

**responsible minister**âmeans the minister responsible for an Act that is ordinarily administered by an appropriate regulator with respect to any class of operators set out in Schedule 2.â(**ministre compÃ©tent**)

**Superintendent**âmeans the Superintendent of Financial Institutions appointed under subsection 5(1) of the `Office of the Superintendent of Financial Institutions Act`.â(**surintendant**)

**Tribunal**âmeans the Transportation Appeal Tribunal of Canada that is established under subsection 2(1) of the `Transportation Appeal Tribunal of Canada Act`.â(**Tribunal**)

**vital service**âmeans a service that is referred to in Schedule 1.â(**service critique**)

**vital system**âmeans a system that is referred to in Schedule 1.â(**systÃ¨me critique**)
...
a class of operators â consisting of persons, partnerships or unincorporated organizations that operate a work or carry on an undertaking or business that is within the legislative authority of Parliament â in respect of a vital service or vital system, and
...
### Section 9
  ...
  **(1)** After an order that is made under section `7` is published in the `Canada Gazette`, Part II, a designated operator that belongs to a class of operators set out in Schedule 2 must, within 90 days after the day on which the designated operator becomes a member of that class, establish a cyber security program in respect of its critical cyber systems and include in the program steps to, in accordance with any regulations,
    ...
    identify and manage any organizational cyber security risks, including risks associated with the designated operatorâs supply chain and its use of third-party products and services;
...
The appropriate regulator may, at the designated operatorâs written request, extend the 90-day period for complying with either subsection `9`(1) or section `10`, or both. The 90-day period may be extended more than once at the discretion of the appropriate regulator.
...
### Section 14
  ...
  **(1)** A designated operator must, within a period prescribed by the regulations, notify the appropriate regulator of
    ...
    any material change in the designated operatorâs ownership or control;

    any material change in the designated operatorâs supply chain or in its use of third-party products and services; and
  ...
  **(3)** The appropriate regulator may, at the designated operatorâs written request, extend the 90-day period for complying with subsection (2). The 90-day period may be extended more than once at the discretion of the appropriate regulator.
...
### Section 30
  ...
  **(1)** Every designated operator must keep records respecting
    ...
    any steps taken to implement the designated operatorâs cyber security program;
...
### Section 32
  ...
  **(4)** Every owner or person in charge of a place that is entered by the Superintendent and every person found in the place must give the Superintendent all reasonable assistance to enable the Superintendent to exercise the Superintendentâs powers or perform the Superintendentâs duties and functions under this Act and provide the Superintendent with any document or information, or access to any data, that the Superintendent may reasonably require.

  **(5)** The Superintendent may be accompanied by any other person that the Superintendent believes is necessary to help the Superintendent exercise the Superintendentâs powers or perform the Superintendentâs duties and functions under this section.
...
### Section 33
  ...
  **(1)** In the case of a dwelling-house, the Superintendent is not authorized to enter it without the occupantâs consent except under the authority of a warrant issued under subsection (2).
...
### Section 41
  ...
  **(4)** Every owner or person in charge of a place that is entered by the inspector and every person found in the place must give the inspector all reasonable assistance to enable the inspector to exercise the inspectorâs powers or perform the inspectorâs duties and functions under this Act and provide that inspector with any document or information, or access to any data, that the inspector may reasonably require.

  **(5)** The inspector may be accompanied by any other person that the inspector believes is necessary to help the inspector exercise the inspectorâs powers or perform the inspectorâs duties and functions under this section.
...
### Section 42
  ...
  **(1)** In the case of a dwelling-house, the inspector is not authorized to enter it without the occupantâs consent except under the authority of a warrant issued under subsection (2).
...
### Section 51
  ...
  **(1)** In the case of a dwelling-house, the person designated under subsection `49`(1) is not authorized to enter it without the occupantâs consent except under the authority of a warrant issued under subsection (2).
...
### Section 60
  ...
  **(1)** In the case of a dwelling-house, the person designated under subsection `58`(1) is not authorized to enter it without the occupantâs consent except under the authority of a warrant issued under subsection (2).
...
### Section 68
  ...
  **(4)** Every owner or person in charge of a place that is entered by the inspection officer and every person found in the place must give the officer all reasonable assistance to enable the officer to exercise the officerâs powers or perform the officerâs duties and functions under this Act and provide that officer with any document or information, or access to any data, that the officer may reasonably require.

  **(5)** The inspection officer may be accompanied by any other person that the inspection officer believes is necessary to help the inspection officer exercise the inspection officerâs powers or perform the inspection officerâs duties and functions under this section.
...
### Section 69
  ...
  **(1)** In the case of a dwelling-house, the inspection officer is not authorized to enter it without the occupantâs consent except under the authority of a warrant issued under subsection (2).
...
The Minister of Transport may delegate, subject to any restrictions or limitations that the Minister of Transport may specify, any of the Minister of Transportâs powers, duties and functions under this Act â other than the power to delegate under this section â to any person or class of persons.
...
### Section 78
  ...
  **(4)** Every owner or person in charge of a place that is entered by the Minister of Transport and every person found in the place must give the Minister of Transport all reasonable assistance to enable the Minister of Transport to exercise the Minister of Transportâs powers or perform the Minister of Transportâs duties and functions under this Act and provide that Minister with any document or information, or access to any data, that the Minister of Transport may reasonably require.

  **(5)** The Minister of Transport may be accompanied by any other person that the Minister of Transport believes is necessary to help the Minister of Transport exercise the Minister of Transportâs powers or perform the Minister of Transportâs duties and functions under this section.
...
### Section 79
  ...
  **(1)** In the case of a dwelling-house, the Minister of Transport is not authorized to enter it without the occupantâs consent except under the authority of a warrant issued under subsection (2).
...
Every designated operator or other person that contravenes or fails to comply with a provision of this Act or of the regulations made under this Act â designated by regulations made under paragraph `135`(1)(f) â commits a violation and is liable to a penalty of an amount to be determined in accordance with this Act and the regulations.
...
the designated operatorâs or other personâs history of compliance or non-compliance with the provisions of this Act or of the regulations;
...
### Section 101
  ...
  **(2)** Instead of paying the penalty set out in the notice, the designated operator or other person named in the notice may, in accordance with the notice,
    ...
    if the Superintendent offers a compliance agreement, enter into the compliance agreement with the Superintendent to ensure the designated operatorâs or other personâs compliance with the provision to which the violation relates.
...
### Section 103
  ...
  **(5)** If the Superintendent is of the opinion that a designated operator or other person that has entered into a compliance agreement has not complied with it, the Superintendent must cause the designated operator or other person to be served with a notice of default informing them that
    ...
    the Superintendent may make public the designated operatorâs or other personâs name, the nature of the violation, the scope of the non-compliance with the compliance agreement and the penalty payable.
...
### Section 107
  ...
  **(2)** Instead of paying the penalty set out in the notice, the designated operator or other person named in the notice may, in accordance with the notice,
    ...
    if the person designated under section `104` offers a compliance agreement, enter into the compliance agreement with the person so designated to ensure the designated operatorâs or other personâs compliance with the provision to which the violation relates.
...
### Section 109
  ...
  **(5)** If the person designated under section `104` is of the opinion that a designated operator or other person that has entered into a compliance agreement has not complied with it, the person so designated must cause the designated operator or other person to be served with a notice of default informing them that
    ...
    the Minister of Industry may make public the designated operatorâs or other personâs name, the nature of the violation, the scope of the non-compliance with the compliance agreement and the penalty payable.
...
### Section 112
  ...
  **(2)** Instead of paying the penalty set out in the notice, the designated operator or other person named in the notice may, in accordance with the notice,
    ...
    if the Bank offers a compliance agreement, enter into the compliance agreement with the Bank to ensure the designated operatorâs or other personâs compliance with the provision to which the violation relates.
...
### Section 114
  ...
  **(5)** If the Bank is of the opinion that a designated operator or other person that has entered into a compliance agreement has not complied with it, the Bank must cause the designated operator or other person to be served with a notice of default informing them that
    ...
    the Bank may make public the designated operatorâs or other personâs name, the nature of the violation, the scope of the non-compliance with the compliance agreement and the penalty payable.
...
### Section 118
  ...
  **(2)** Instead of paying the penalty set out in the notice, the designated operator or other person named in the notice may, in accordance with the notice,
    ...
    if the person designated under section `115` offers a compliance agreement, enter into the compliance agreement with the person so designated to ensure the designated operatorâs or other personâs compliance with the provision to which the violation relates.
...
### Section 120
  ...
  **(5)** If the person designated under section `115` is of the opinion that a designated operator or other person that has entered into a compliance agreement has not complied with it, the person so designated must cause the designated operator or other person to be served with a notice of default informing them that
    ...
    the Canadian Nuclear Safety Commission may make public the designated operatorâs or other personâs name, the nature of the violation, the scope of the non-compliance with the compliance agreement and the penalty payable.
...
### Section 124
  ...
  **(2)** Instead of paying the penalty set out in the notice, the designated operator or other person named in the notice may, in accordance with the notice,
    ...
    if the person designated under section `121` offers a compliance agreement, enter into the compliance agreement with the person so designated to ensure the designated operatorâs or other personâs compliance with the provision to which the violation relates.
...
### Section 126
  ...
  **(5)** If the person designated under section `121` is of the opinion that a designated operator or other person that has entered into a compliance agreement has not complied with it, the person designated under section `121` must cause the designated operator or other person to be served with a notice of default informing them that
    ...
    the Canadian Energy Regulator may make public the designated operatorâs or other personâs name, the nature of the violation, the scope of the non-compliance with the compliance agreement and the penalty payable.
...
### Section 129
  ...
  **(2)** Instead of paying the penalty set out in the notice, the designated operator or other person named in the notice may, in accordance with the notice,
    ...
    if the Minister of Transport offers a compliance agreement, enter into the compliance agreement with the Minister of Transport to ensure the designated operatorâs or other personâs compliance with the provision to which the violation relates.
...
### Section 134
  ...
  **(5)** If the Minister of Transport is of the opinion that a designated operator or other person that has entered into a compliance agreement has not complied with it, the Minister of Transport must cause the designated operator to be served with a notice of default informing them that
    ...
    the Minister of Transport may make public the designated operatorâs or other personâs name, the nature of the violation, the scope of the non-compliance with the compliance agreement and the penalty payable.
...
A person, partnership or unincorporated organization is not to be found guilty of an offence under this Act â other than an offence under section `137` that is in respect of a contravention of section 26 or paragraph 87(a) or (b) â if they establish that they exercised all due diligence to prevent the commission of the offence.
