...
`CanadaâIndonesia Comprehensive Economic Partnership Agreement Implementation Act`
...
This Act may be cited as the `CanadaâIndonesia Comprehensive Economic Partnership Agreement Implementation Act`.
...
**Agreement**âmeans the Comprehensive Economic Partnership Agreement between Canada and Indonesia, done at Ottawa on September 24, 2025.â(**Accord**)

**Committee**âmeans the Joint Committee established under Article 23.1 of the Agreement.â(**ComitÃ©**)

**federal law**âmeans the whole or any portion of an Act of Parliament or a regulation, order or other instrument issued, made or established in the exercise of a power conferred by or under an Act of Parliament.â(**texte lÃ©gislatif fÃ©dÃ©ral**)

**Minister**âmeans the Minister for International Trade.â(**ministre**)
...
### Section 12
  ...
  **(5)** The Minister may delegate the Ministerâs powers, duties or functions under any of subsections (1) to (4) to any officer of the Department of Foreign Affairs, Trade and Development.
...
The schedule to the `Investment Canada Act` is amended by adding, at the end of column 1, a reference to âAgreement within the meaning of section 2 of the `CanadaâIndonesia Comprehensive Economic Partnership Agreement Implementation Act`â and a corresponding reference to âArticle 1.5â in column 2.
...
**CICEPA**âhas the same meaning as Agreement in section 2 of the `CanadaâIndonesia Comprehensive Economic Partnership Agreement Implementation Act`.â(**APÃGCI**)

**Indonesia**âhas the same meaning as in subsection 2(1) of the `Customs Tariff`.â(**IndonÃ©sie**)
...
Part 1 of the schedule to the Act is amended by adding, in alphabetical order, a reference to âIndonesiaâ in column 1, a corresponding reference to âCICEPAâ in column 2 and a corresponding reference to âIndonesia Tariff rates of customs duty under the `Customs Tariff`â in column 3.

### Section 22

Part 2 of the schedule to the Act is amended by adding, in alphabetical order, a reference to âCICEPAâ in column 1 and a corresponding reference to âparagraph 4 of Article 3.25â in column 2.

### Section 23

Part 3 of the schedule to the Act is amended by adding, in alphabetical order, a reference to âIndonesiaâ in column 1 and a corresponding reference to âsubparagraphs 1(a), (c) and (d) of Article 4.8 of CICEPAâ in column 2.

### Section 24

Part 4 of the schedule to the Act is amended by adding, in alphabetical order, a reference to âIndonesiaâ in column 1 and a corresponding reference to âCICEPAâ in column 2.

### Section 25

Part 5 of the schedule to the Act is amended by adding, in alphabetical order, a reference to âCICEPAâ in column 1 and a corresponding reference to âChapters 3 and 4â in column 2.
...
Schedule 2 to the `Commercial Arbitration Act` is amended by adding, at the end of column 1, a reference to âArticle 13.25â and a corresponding reference to âComprehensive Economic Partnership Agreement between Canada and Indonesia, done at Ottawa on September 24, 2025â in column 2.
...
### Section 27
  ...
  **(2)** Subsection 2(5) of the Act is amended by adding, in alphabetical order, a reference to âIndonesiaâ in the list of countries.
...
**CanadaâIndonesia Comprehensive Economic Partnership Agreement**âhas the same meaning as Agreement in section 2 of the `CanadaâIndonesia Comprehensive Economic Partnership Agreement Implementation Act`.â(**Accord de partenariat Ã©conomique global CanadaâIndonÃ©sie**)

**Indonesia**âmeans the land territories, internal waters, archipelagic waters, territorial sea, including the seabed and subsoil thereof, and air space over such territories and waters, as well as the contiguous zone, the continental shelf and exclusive economic zone, over which Indonesia has sovereignty, sovereign rights or jurisdiction as defined in its laws, and in accordance with international law, including the United Nations Convention on the Law of the Sea, done at Montego Bay on December 10, 1982.â(**IndonÃ©sie**)
...
**IDT**ârefers to the Indonesia Tariff.â(**TID**)
...
### Section 49.71
  ...
  **(2)** If âAâ is set out in the column entitled âPreferential Tariffâ in the List of Tariff Provisions following the abbreviation âIDTâ in relation to goods entitled to the Indonesia Tariff, the Indonesia Tariff rate of customs duty that applies to those goods is the final rate of âFreeâ.

  **(3)** If âFâ is set out in the column entitled âPreferential Tariffâ in the List of Tariff Provisions following the abbreviation âIDTâ in relation to goods entitled to the Indonesia Tariff, the Indonesia Tariff rate of customs duty that applies to those goods is the initial rate, reduced as provided in the âFâ Staging List.

  **(4)** If âY1â, âY2â or âY3â is set out in the column entitled âPreferential Tariffâ in the List of Tariff Provisions following the abbreviation âIDTâ in relation to goods entitled to the Indonesia Tariff, the Indonesia Tariff rate of customs duty that applies to those goods is the initial rate, reduced
    ...
    effective on January 1 of the year that is four years after the year of the coming into force of this subsection, to the final rate of âFreeâ;
    ...
    effective on January 1 of the year that is nine years after the year of the coming into force of this subsection, to the final rate of âFreeâ; and
    ...
    effective on January 1 of the year that is 14 years after the year of the coming into force of this subsection, to the final rate of âFreeâ.
  ...
  **(7)** If a reduction under subsection (3) or (4) results in a rate of customs duty that is a percentage of less than two per cent, the rate shall be further reduced to âFreeâ immediately.
...
### Section 75
  ...
  **(2)** An order under subsection (1)
    ...
    if the order is in respect of goods for which the Indonesia Tariff rate of customs duty is reduced to the final rate of âFreeâ over a period of less than 10 years, on the day that is 10 years after the day on which this subsection comes into force, and

    if the order is in respect of goods for which the Indonesia Tariff rate of customs duty is reduced to the final rate of âFreeâ over a period of 10 years or more, on the day after the expiry of the tariff staging period in respect of those goods.
...
The List of Countries and Applicable Tariff Treatments set out in the schedule to the Act is amended by adding, in the column âTariff Treatment / Otherâ, a reference to âIDTâ opposite the reference to âIndonesiaâ.

### Section 44

The List of Tariff Provisions set out in the schedule to the Act is amended by

adding in the column âPreferential Tariff / Initial Rateâ, above the reference to âGPTâ, a reference to âIDT:â;

adding in the column âPreferential Tariff / Final Rateâ, above the reference to âGPTâ, a reference to âIDT:â;

adding in the column âPreferential Tariff / Initial Rateâ a reference to âFreeâ after the abbreviation âIDTâ, and adding in the column âPreferential Tariff / Final Rateâ a reference to âFree (A)â after the abbreviation âIDTâ, for all tariff items except those tariff items set out in Schedules 1 and 2 to this Act;

adding in the columns âPreferential Tariff / Initial Rateâ and âPreferential Tariff / Final Rateâ, a reference to âN/Aâ after the abbreviation âIDTâ for those tariff items set out in Schedule 1 to this Act; and

adding in the columns âPreferential Tariff / Initial Rateâ and âPreferential Tariff / Final Rateâ after the abbreviation âIDTâ, for each tariff item set out in Schedule 2 to this Act, the rates of duty and staging categories set out with respect to that tariff item in that Schedule.
