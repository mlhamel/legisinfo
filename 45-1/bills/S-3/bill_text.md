...
### Section 1
  ...
  **(3)** Section 2 of the Act is amended by adding the following in alphabetical order:
    ...
    **vehicle**âmeans a vessel, aircraft, train, motor vehicle, trailer or other means of transportation and includes a cargo container;â(**vÃ©hicule**)
...
### Section 28
  ...
  **(3)** Subsection 2(1) of the Act is amended by adding the following in alphabetical order:
    ...
    **authorized service provider**âmeans any person to whom an authorization is granted under subsection 10(1);â(**fournisseur de services autorisÃ©**)

    **designated inspector**âmeans any person who is designated under subsection 26(3);â(**inspecteur dÃ©signÃ©**)

    **president**âmeans the president appointed under subsection 26(1);â(**prÃ©sident**)
...
### Section 12.3
  ...
  **(1)** Subject to subsection (3), the president may, by written notice, suspend or revoke
    ...
    an authorization granted under subsection 10(1);Â or
...
The Act is amended by replacing âdirectorâ with âpresidentâ in the following provisions:
...
**accredited meter verifier**âhas the same meaning as in subsection 2(1) of the former Act.â(**vÃ©rificateur accrÃ©ditÃ©**)

**authorized service provider**âhas the same meaning as in subsection 2(1) of the new Act.â(**fournisseur de services autorisÃ©**)

**commencement day**âmeans the day on which this section comes into force.â(**date de rÃ©fÃ©rence**)

**designated inspector**âhas the same meaning as in subsection 2(1) of the new Act.â(**inspecteur dÃ©signÃ©**)

**director**âhas the same meaning as in subsection 2(1) of the former Act.â(**directeur**)

**former Act**âmeans the `Electricity and Gas Inspection Act` as it read immediately before the commencement day.â(**ancienne loi**)

**new Act**âmeans the `Electricity and Gas Inspection Act` as it reads on the commencement day.â(**nouvelle loi**)

**president**âhas the same meaning as in subsection 2(1) of the new Act.â(**prÃ©sident**)
